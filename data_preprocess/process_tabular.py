...
class Data_Loader:
    ...
    def get_dataset(self, dataset_name):
        ...
        mat_files = ['annthyroid', 'arrhythmia', 'breastw', 'cardio', 'forest_cover', 'glass', 'ionosphere', 'letter',
                     'lympho', 'mammography', 'mnist', 'musk',
                     'optdigits', 'pendigits', 'pima', 'satellite', 'satimage', 'shuttle', 'speech', 'thyroid',
                     'vertebral', 'vowels', 'wbc', 'wine']
    ...
    def build_train_test_generic_matfile(self,
                                         name_of_file):  # takes a matrice that contains the entire dataset, and creates a trainset with 50% of the data of all normals, and the rest are test
    ...
    def build_train_test_seismic(self,
                                 name_of_file):  # takes a matrice that contains the entire dataset, and creates a trainset with 50% of the data of all normals, and the rest are test
    ...
    def build_train_test_mulcross(self,
                                  name_of_file):  # takes a matrice that contains the entire dataset, and creates a trainset with 50% of the data of all normals, and the rest are test
    ...
    def build_train_test_ecoli(self,
                               name_of_file):  # takes a matrice that contains the entire dataset, and creates a trainset with 50% of the data of all normals, and the rest are test
    ...
    def build_train_test_abalone(self,
                                 path):  # takes a matrice that contains the entire dataset, and creates a trainset with 50% of the data of all normals, and the rest are test
    ...
    def build_train_test_kdd(self,
        ...
        new_columns = [0, 'new1_icmp', 'new1_tcp', 'new1_udp', 'new2_IRC', 'new2_X11', 'new2_Z39_50', 'new2_auth',
                       ...
                       'new2_imap4',
                       'new2_iso_tsap', 'new2_klogin', 'new2_kshell', 'new2_ldap', 'new2_link', 'new2_login',
                       'new2_mtp',
                       'new2_name', 'new2_netbios_dgm', 'new2_netbios_ns', 'new2_netbios_ssn', 'new2_netstat',
                       'new2_nnsp',
                       'new2_nntp', 'new2_ntp_u', 'new2_other', 'new2_pm_dump', 'new2_pop_2', 'new2_pop_3',
                       'new2_printer',
                       'new2_private', 'new2_red_i', 'new2_remote_job', 'new2_rje', 'new2_shell', 'new2_smtp',
                       'new2_sql_net',
                       'new2_ssh', 'new2_sunrpc', 'new2_supdup', 'new2_systat', 'new2_telnet', 'new2_tftp_u',
                       'new2_tim_i',
                       'new2_time', 'new2_urh_i', 'new2_urp_i', 'new2_uucp', 'new2_uucp_path', 'new2_vmnet',
                       'new2_whois',
                       'new3_OTH', 'new3_REJ', 'new3_RSTO', 'new3_RSTOS0', 'new3_RSTR', 'new3_S0', 'new3_S1', 'new3_S2',
                       'new3_S3', 'new3_SF', 'new3_SH', 4, 5, 'new6_0', 'new6_1', 7, 8, 9, 10, 'new11_0', 'new11_1', 12,
                       13,
                       14,
    ...
    def build_train_test_kdd_rev(self,
                                 name_of_file):  # takes a matrice that contains the entire dataset, and creates a trainset with 50% of the data of all normals, and the rest are test
        zf = zipfile.ZipFile(name_of_file)
        kdd_loader = pd.read_csv(zf.open('kddcup.data_10_percent_corrected'), delimiter=',')
        entire_set = np.array(kdd_loader)
